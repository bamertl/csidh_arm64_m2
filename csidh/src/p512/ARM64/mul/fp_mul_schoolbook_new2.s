...
_uint_mul_512x512: 
	...
	/* C2 */
	umulh x20, x3, x12  //  FREE_REGS[0] = A_REGS[0] umulh B_REGS[1] 
	mul x21, x3, x13  // FREE_REGS[1] = A_REGS[0] mul B_REGS[2] 
	umulh x22, x4, x11  //  FREE_REGS[2] = A_REGS[1] umulh B_REGS[0] 
	mul x23, x4, x12  // FREE_REGS[3] = A_REGS[1] mul B_REGS[1] 
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	...
	mul x20, x4, x13  // FREE_REGS[0] = A_REGS[1] mul B_REGS[2] 
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	adcs x28, x28, x22  
	adcs x30, x30, xzr  
	...
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	umulh x21, x5, x11  //  FREE_REGS[1] = A_REGS[2] umulh B_REGS[0] 
	mul x22, x5, x12  // FREE_REGS[2] = A_REGS[2] mul B_REGS[1] 
	mul x23, x6, x11  // FREE_REGS[3] = A_REGS[3] mul B_REGS[0] 
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	adcs x28, x28, x22  
	adcs x30, x30, xzr  
	...
	adcs x28, x28, x23  
	adcs x30, x30, xzr  
	umulh x20, x5, x12  //  FREE_REGS[0] = A_REGS[2] umulh B_REGS[1] 
	mul x21, x5, x13  // FREE_REGS[1] = A_REGS[2] mul B_REGS[2] 
	umulh x22, x6, x11  //  FREE_REGS[2] = A_REGS[3] umulh B_REGS[0] 
	mul x23, x6, x12  // FREE_REGS[3] = A_REGS[3] mul B_REGS[1] 
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	...
	mul x20, x4, x15  // FREE_REGS[0] = A_REGS[1] mul B_REGS[4] 
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	adcs x28, x28, x22  
	adcs x30, x30, xzr  
	...
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	umulh x21, x5, x13  //  FREE_REGS[1] = A_REGS[2] umulh B_REGS[2] 
	mul x22, x5, x14  // FREE_REGS[2] = A_REGS[2] mul B_REGS[3] 
	umulh x23, x6, x12  //  FREE_REGS[3] = A_REGS[3] umulh B_REGS[1] 
	...
	/* C6 */
	umulh x20, x3, x16  //  FREE_REGS[0] = A_REGS[0] umulh B_REGS[5] 
	mul x21, x3, x17  // FREE_REGS[1] = A_REGS[0] mul B_REGS[6] 
	umulh x22, x4, x15  //  FREE_REGS[2] = A_REGS[1] umulh B_REGS[4] 
	mul x23, x4, x16  // FREE_REGS[3] = A_REGS[1] mul B_REGS[5] 
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	...
	adcs x28, x28, x23  
	adcs x30, x30, xzr  
	umulh x20, x7, x12  //  FREE_REGS[0] = A_REGS[4] umulh B_REGS[1] 
	mul x21, x7, x13  // FREE_REGS[1] = A_REGS[4] mul B_REGS[2] 
	umulh x22, x8, x11  //  FREE_REGS[2] = A_REGS[5] umulh B_REGS[0] 
	mul x23, x8, x12  // FREE_REGS[3] = A_REGS[5] mul B_REGS[1] 
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	...
	mul x20, x4, x17  // FREE_REGS[0] = A_REGS[1] mul B_REGS[6] 
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	adcs x28, x28, x22  
	adcs x30, x30, xzr  
	...
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	umulh x21, x5, x15  //  FREE_REGS[1] = A_REGS[2] umulh B_REGS[4] 
	mul x22, x5, x16  // FREE_REGS[2] = A_REGS[2] mul B_REGS[5] 
	umulh x23, x6, x14  //  FREE_REGS[3] = A_REGS[3] umulh B_REGS[3] 
	...
	mul x20, x8, x13  // FREE_REGS[0] = A_REGS[5] mul B_REGS[2] 
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	adcs x28, x28, x22  
	adcs x30, x30, xzr  
	...
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	umulh x21, x9, x11  //  FREE_REGS[1] = A_REGS[6] umulh B_REGS[0] 
	mul x22, x9, x12  // FREE_REGS[2] = A_REGS[6] mul B_REGS[1] 
	mul x23, x10, x11  // FREE_REGS[3] = A_REGS[7] mul B_REGS[0] 
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	adcs x28, x28, x22  
	adcs x30, x30, xzr  
	...
	adcs x28, x28, x23  
	adcs x30, x30, xzr  
	mul x20, x5, x17  // FREE_REGS[0] = A_REGS[2] mul B_REGS[6] 
	umulh x21, x6, x15  //  FREE_REGS[1] = A_REGS[3] umulh B_REGS[4] 
	mul x22, x6, x16  // FREE_REGS[2] = A_REGS[3] mul B_REGS[5] 
	umulh x23, x7, x14  //  FREE_REGS[3] = A_REGS[4] umulh B_REGS[3] 
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	...
	adcs x28, x28, x23  
	adcs x30, x30, xzr  
	mul x20, x9, x13  // FREE_REGS[0] = A_REGS[6] mul B_REGS[2] 
	umulh x21, x10, x11  //  FREE_REGS[1] = A_REGS[7] umulh B_REGS[0] 
	mul x22, x10, x12  // FREE_REGS[2] = A_REGS[7] mul B_REGS[1] 
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	...
	/* C9 */
	umulh x23, x4, x19  //  FREE_REGS[3] = A_REGS[1] umulh B_REGS[7] 
	...
	umulh x20, x7, x15  //  FREE_REGS[0] = A_REGS[4] umulh B_REGS[4] 
	mul x21, x7, x16  // FREE_REGS[1] = A_REGS[4] mul B_REGS[5] 
	umulh x22, x8, x14  //  FREE_REGS[2] = A_REGS[5] umulh B_REGS[3] 
	adcs x28, x28, x23  
	adcs x30, x30, xzr  
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	...
	adcs x28, x28, x22  
	adcs x30, x30, xzr  
	mul x23, x8, x15  // FREE_REGS[3] = A_REGS[5] mul B_REGS[4] 
	...
	/* C10 */
	umulh x20, x5, x19  //  FREE_REGS[0] = A_REGS[2] umulh B_REGS[7] 
	umulh x21, x6, x17  //  FREE_REGS[1] = A_REGS[3] umulh B_REGS[6] 
	mul x22, x6, x19  // FREE_REGS[2] = A_REGS[3] mul B_REGS[7] 
	umulh x23, x7, x16  //  FREE_REGS[3] = A_REGS[4] umulh B_REGS[5] 
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	...
	adcs x28, x28, x23  
	adcs x30, x30, xzr  
	mul x20, x9, x15  // FREE_REGS[0] = A_REGS[6] mul B_REGS[4] 
	umulh x21, x10, x13  //  FREE_REGS[1] = A_REGS[7] umulh B_REGS[2] 
	mul x22, x10, x14  // FREE_REGS[2] = A_REGS[7] mul B_REGS[3] 
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	...
	/* C11 */
	umulh x23, x6, x19  //  FREE_REGS[3] = A_REGS[3] umulh B_REGS[7] 
	...
	umulh x20, x9, x15  //  FREE_REGS[0] = A_REGS[6] umulh B_REGS[4] 
	mul x21, x9, x16  // FREE_REGS[1] = A_REGS[6] mul B_REGS[5] 
	umulh x22, x10, x14  //  FREE_REGS[2] = A_REGS[7] umulh B_REGS[3] 
	adcs x28, x28, x23  
	adcs x30, x30, xzr  
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	...
	adcs x28, x28, x22  
	adcs x30, x30, xzr  
	mul x23, x10, x15  // FREE_REGS[3] = A_REGS[7] mul B_REGS[4] 
	adcs x28, x28, x23  
	adcs x30, x30, xzr  
	str x28, [x2, #88]  
	mov x28, x30  
	...
	adcs x28, x28, x23  
	adcs x30, x30, xzr  
	mul x20, x9, x17  // FREE_REGS[0] = A_REGS[6] mul B_REGS[6] 
	umulh x21, x10, x15  //  FREE_REGS[1] = A_REGS[7] umulh B_REGS[4] 
	mul x22, x10, x16  // FREE_REGS[2] = A_REGS[7] mul B_REGS[5] 
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	...
	/* C13 */
	umulh x23, x8, x19  //  FREE_REGS[3] = A_REGS[5] umulh B_REGS[7] 
	...
	/* C14 */
	umulh x20, x9, x19  //  FREE_REGS[0] = A_REGS[6] umulh B_REGS[7] 
	umulh x21, x10, x17  //  FREE_REGS[1] = A_REGS[7] umulh B_REGS[6] 
	mul x22, x10, x19  // FREE_REGS[2] = A_REGS[7] mul B_REGS[7] 
	adcs x28, x28, x20  
	adcs x30, x30, xzr  
	adcs x28, x28, x21  
	adcs x30, x30, xzr  
	...
	/* C15 */
	umulh x23, x10, x19  //  FREE_REGS[3] = A_REGS[7] umulh B_REGS[7] 
	adcs x28, x28, x23  
	adcs x30, x30, xzr  
	str x28, [x2, #120]  
	mov x28, x30  
